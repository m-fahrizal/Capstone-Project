...
//        })
    ...
    fun postData(
        ...
        tanggalLahir: RequestBody,
        namaIbu: RequestBody,
        alamat: RequestBody,
        kodePos: RequestBody,
        agama: RequestBody,
        gaji: RequestBody,
        asalSekolah: RequestBody,
        statusSekolah: RequestBody,
        prestasi: RequestBody,
        nilaiUjian: RequestBody,
        statusKip: RequestBody,
        statusRumah: RequestBody,
